...
\todo{DAVIDSSON: PLAUSIBLE DENIABILITY}
...
\todo{Davidsson mentions :\tabularnewline
The SD-card adapter is designed to appear as a generic
SD-card adapter with the exception that it encrypts the data and hides any changes in the file system.\tabularnewline
• The device should hide encrypted files from previous sessions.\tabularnewline
The modification clusters are used to store alterations to the preallocated
folders where the tools have specified to hide encrypted files after power down.\tabularnewline
the system hides previously created encrypted files from the
camera.\tabularnewline
}
