...
One round consits of four transformations,
...
\item [AddRoundkey] In this final step we apply bitwise XOR to the current block with the round key.
\end{labeling}
...
In the following subsection we describe more detailed, how the solution by Peters et. al. works.
In this subsection we only consider what encryption scheme it uses.
They use AES-CTR (AES in counter mode), which means as initialization vector a counter will be used. \cite{peters2015defy}
...
\todo{How does Peters do Plausible Deniability?}
